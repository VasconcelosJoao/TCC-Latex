...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.5\textwidth]{figuras/plano_de_trabalho.eps}
...
%% Sugestão de imagem: Um diagrama conceitual ilustrando o fluxo de tradução na camada de tradução, desde o comando em português até o comando SQL padrão. Prompt: 'A conceptual diagram illustrating the translation layer in a database system, mapping SQL commands from Portuguese to ANSI SQL syntax.'
...
%% Sugestão de imagem: Um diagrama arquitetural destacando o papel do middleware na integração entre o front-end e o banco de dados. Prompt: 'An architectural diagram showing the middleware layer connecting the Flutter frontend and MySQL database.'
