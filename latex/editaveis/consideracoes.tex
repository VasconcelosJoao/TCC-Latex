...
\begin{enumerate}[label=\textbf{RF\arabic*:}, leftmargin=*, align=left]
...
\begin{enumerate}[label=\textbf{RNF\arabic*:}, leftmargin=*, align=left]
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{figuras/ArquiteturadeMiddlewareparaAplicacaodeTraducao.eps}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{figuras/FluxodeDadosnoSistemadeTraducao.eps}
